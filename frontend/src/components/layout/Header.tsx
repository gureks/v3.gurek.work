...
export function Header() {
  ...
  return (
    <header className="w-full flex items-center justify-end" style={{ height: '84px' }}>
      <div className="flex items-center" style={{ gap: 'var(--space-3)' }}>
        {/* Icon Buttons */}
        <button className="flex items-center justify-center transition-colors hover:bg-black/10 dark:hover:bg-white/10 text-foreground" style={{ width: '36px', height: '36px', borderRadius: 'var(--radius-sm)', backgroundColor: 'var(--background-elevated)' }}>
          <SearchIcon size={20} />
        </button>
        <button 
          onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}
          className="flex items-center justify-center transition-colors hover:bg-black/10 dark:hover:bg-white/10 text-foreground" 
          style={{ width: '36px', height: '36px', borderRadius: 'var(--radius-sm)', backgroundColor: 'var(--background-elevated)' }}>
        ...
        {/* User Pill */}
        <div className="flex items-center text-foreground" style={{ height: '36px', padding: '4px 12px 4px 4px', borderRadius: 'var(--radius-sm)', backgroundColor: 'var(--background-elevated)', gap: 'var(--space-2)' }}>
          <div className="flex items-center justify-center text-xs font-medium text-white" style={{ width: '28px', height: '28px', borderRadius: '50%', backgroundColor: 'var(--accent)' }}>AB</div>
