  ...
  return (
    <header className="w-full flex items-center justify-end" style={{ height: '84px' }}>
      <div className="flex items-center" style={{ gap: 'var(--space-3)' }}>
        {/* Icon Buttons */}
        <button className="flex items-center justify-center transition-colors hover:bg-white/10 text-foreground" style={{ width: '36px', height: '36px', borderRadius: 'var(--radius-sm)', backgroundColor: 'var(--background-elevated)' }}>
          <SearchIcon size={20} />
        </button>
        <button className="flex items-center justify-center transition-colors hover:bg-white/10 text-foreground" style={{ width: '36px', height: '36px', borderRadius: 'var(--radius-sm)', backgroundColor: 'var(--background-elevated)' }}>
