  ...
  return (
    ...
    >
      <div className="flex items-center" style={{ gap: 'var(--space-2)' }}>
        {/* Icon Buttons */}
        <button className="flex items-center justify-center transition-colors hover:bg-white/10 text-foreground" style={{ padding: 'var(--space-2)', borderRadius: 'var(--radius-sm)', backgroundColor: 'var(--background-elevated)', backdropFilter: 'blur(4px)' }}>
          <SearchIcon size={20} />
        </button>
        <button className="flex items-center justify-center transition-colors hover:bg-white/10 text-foreground" style={{ padding: 'var(--space-2)', borderRadius: 'var(--radius-sm)', backgroundColor: 'var(--background-elevated)', backdropFilter: 'blur(4px)' }}>
        ...
        {HEADER_CTA.visible && (
          <a
            ...
            style={{
              ...
              gap: 'var(--space-1)',
              boxShadow: '0px 0px 15px -2px #006eff'
            }}
          >
            <span style={{ fontSize: '14px', fontWeight: 500, lineHeight: '16px' }}>{HEADER_CTA.label}</span>
        ...
        {/* User Pill */}
        <div className="flex items-center text-foreground" style={{ padding: 'var(--space-2)', borderRadius: 'var(--radius-sm)', backgroundColor: 'var(--background-elevated)', border: '1px solid var(--border)', gap: 'var(--space-2)', boxShadow: '0px 1px 2px 0px rgba(0,0,0,0.05)' }}>
          <div className="flex items-center justify-center font-medium text-white" style={{ width: '20px', height: '20px', borderRadius: '32px', backgroundColor: 'var(--accent)', fontSize: '7.375px', lineHeight: '10px' }}>AB</div>
          <span className="font-normal" style={{ fontSize: '14px', lineHeight: '20px', color: 'var(--foreground-muted)' }}>FirstName</span>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M4 6L8 10L12 6" stroke="var(--foreground-muted)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
      </div>
    </header>
